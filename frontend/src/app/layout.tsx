...
const SITE_URL = "https://paqshi.com";
const SITE_NAME = "PAQSHI";
const SITE_TITLE = "PAQSHI — Intelligence Fusion";
const SITE_DESCRIPTION = "Paqshi — real-time global intelligence fusion. Live flight tracking, maritime chokepoints, satellites, CCTV, weather, cyber threats and reconnaissance on a GPU-accelerated 3D globe.";
...
export const metadata: Metadata = {
  ...
  title: {
    default: SITE_TITLE,
    template: "%s | PAQSHI Intelligence",
  },
  ...
  authors: [{ name: "Paqshi", url: SITE_URL }],
  creator: "Paqshi",
  publisher: "Paqshi",
  robots: {
    index: true,
  ...
  openGraph: {
    title: "PAQSHI — Intelligence Fusion",
    description: SITE_DESCRIPTION,
    type: "website",
    siteName: SITE_NAME,
    locale: "en_US",
    ...
    images: [
      {
        url: `${SITE_URL}/PaqshiLogo.png`,
        width: 1200,
        height: 630,
        alt: "PAQSHI — Intelligence Fusion",
        type: "image/png",
      },
    ],
  },
  twitter: {
    ...
    title: "PAQSHI — Intelligence Fusion",
    description: SITE_DESCRIPTION,
    images: [`${SITE_URL}/PaqshiLogo.png`],
  },
  category: "technology",
  ...
  other: {
    ...
    "apple-mobile-web-app-title": "PAQSHI",
