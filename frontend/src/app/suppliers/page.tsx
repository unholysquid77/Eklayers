  ...
  return (
    <div className="flex-1 space-y-6 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto w-full font-mono">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-[#112818] pb-4">
        ...
        <Link
          href="/scenarios"
          className="flex items-center gap-2 rounded border border-[#00e676]/50 bg-[#00e676]/15 px-4 py-2 text-xs font-bold text-[#00e676] hover:bg-[#00e676]/25 shadow-[0_0_15px_rgba(0,255,136,0.15)] transition"
        >
      ...
      <div className="rounded-xl border border-amber-500/40 bg-[#020503] p-5 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-[#000000] p-4 rounded-lg border border-[#112818] space-y-2">
          ...
          <div className="bg-[#000000] p-4 rounded-lg border border-[#112818] space-y-2">
            ...
            <div className="flex justify-between text-xs">
              ...
              <span className="text-[#00e676] font-bold">64% (Gamma Packaging)</span>
            </div>
            <div className="h-2 w-full rounded-full bg-[#112818] overflow-hidden">
              <div className="h-full bg-[#00e676]" style={{ width: '64%' }} />
            </div>
            <div className="pt-2">
              <Link
                href="/scenarios"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="border-b border-[#112818] pb-2">
            <span className="text-[10px] text-[#00e676] font-bold uppercase">[TIER-1 SUPPLIERS]</span>
              ...
              return (
                <div
                  ...
                  className={`rounded-xl border p-5 cursor-pointer transition space-y-3 ${
                    isSelected
                      ? 'border-[#00e676] bg-[#00e676]/10 shadow-[0_0_20px_rgba(0,255,136,0.15)]'
                      : 'border-[#112818] bg-[#020503] hover:border-[#00e676]/40'
                  }`}
                >
                  <div className="flex items-start justify-between">
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="rounded bg-[#00e676]/20 px-2 py-0.5 text-[9px] font-bold text-[#00e676]">
                  ...
                  {/* Metrics Row */}
                  <div className="grid grid-cols-4 gap-2 text-center text-xs border-t border-[#112818] pt-3">
                    ...
                    <div className="bg-[#000000] p-2 rounded border border-[#112818]">
                      ...
                      <div className="font-bold text-[#00e676] mt-0.5">{sup.quality_pct}%</div>
                    </div>
                    <div className="bg-[#000000] p-2 rounded border border-[#112818]">
                  ...
                  {/* Tier-2 summary */}
                  <div className="flex items-center justify-between text-xs text-[#87a894] border-t border-[#112818] pt-2">
        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          <div className="rounded-xl border border-[#112818] bg-[#020503] p-5 space-y-4">
            <div className="flex items-center justify-between border-b border-[#112818] pb-2">
              <div className="flex items-center gap-1.5">
                <GitBranch className="w-4 h-4 text-[#00e676]" />
            ...
            {/* Tree View */}
            <div className="space-y-3 bg-[#000000] p-4 rounded-lg border border-[#112818] text-xs">
              <div className="flex items-center gap-2">
                <span className="rounded bg-[#00e676]/20 px-1.5 py-0.5 text-[9px] font-bold text-[#00e676]">
                  TIER 1
                </span>
          ...
          <div className="rounded-xl border border-[#00e676]/40 bg-[#020503] p-5 space-y-4">
            <div className="flex items-center justify-between border-b border-[#112818] pb-2">
              <span className="text-[10px] text-[#00e676] font-bold uppercase">[ALTERNATIVE SOURCING]</span>
            ...
            {selectedSupplier.alternatives && selectedSupplier.alternatives.length > 0 ? (
              <div className="space-y-3">
                {selectedSupplier.alternatives.map((alt) => (
                  <div
                    key={alt.supplier_id}
                    className="bg-[#000000] p-3.5 rounded-lg border border-[#112818] space-y-2 text-xs"
                  >
                    <div className="flex items-center justify-between">
                      <strong className="text-white">{alt.name}</strong>
                      <span className="text-[#00e676] font-bold">Risk: {alt.risk_score}</span>
                    </div>
                      ...
                      <button
                        ...
                        className={`rounded px-3 py-1 text-xs font-bold transition ${
                          simulatedSwitch === alt.supplier_id
                            ...
                            : 'border border-[#00e676]/50 bg-[#00e676]/15 text-[#00e676] hover:bg-[#00e676]/25'
                        }`}
                      >
            ...
            {simulatedSwitch && (
              <div className="rounded border border-[#00e676]/40 bg-[#00e676]/10 p-3 text-[11px] text-[#d1fae5] space-y-1 animate-in fade-in">
                <span className="font-bold text-[#00e676]">SIMULATION IMPACT:</span>
                ...
                <div className="pt-2">
                  <Link href="/scenarios" className="text-xs text-[#00e676] underline font-bold">
