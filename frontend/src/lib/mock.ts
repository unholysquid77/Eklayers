  ...
  "chokepoints": [
    {
        ...
        "stress_level": 0.96,
        "baseline": 0.2,
        "baseline_vessels_day": 78,
        "throughput_pct": 0.34,
        "epistemic_status": "COMBAT ZONE AVOIDANCE",
        "criticality": 0.95,
        "country": "Yemen / Djibouti",
        "key_commodities": "Asian Electronics, European Machinery, Jet Fuel, Grain",
        "delay_days": 12.5
    },
    {
        ...
        "stress_level": 0.95,
        "baseline": 0.2,
        "baseline_vessels_day": 76,
        "throughput_pct": 0.35,
        "epistemic_status": "COMBAT ESCORT PATROL",
        "criticality": 0.92,
        "country": "Yemen / Somalia",
        "key_commodities": "Asia-Europe Container Liners, Tanker Convoys",
        "delay_days": 12.0
    },
    {
        ...
        "baseline_vessels_day": 76,
        "throughput_pct": 0.35,
        "epistemic_status": "HIGH THREAT ZONE",
        "criticality": 0.92,
        "country": "Somalia / Yemen",
        "key_commodities": "Commercial Bulk & Container Traffic",
        "delay_days": 12.0
    },
    {
        "id": "cp.strait_of_hormuz",
        "name": "Strait of Hormuz Tanker Fairway",
        "category": "maritime",
        "latitude": 26.566,
        "longitude": 56.25,
        "stress_level": 0.94,
        "baseline": 0.25,
        "baseline_vessels_day": 84,
        "throughput_pct": 0.68,
        "epistemic_status": "CRITICAL - AIS ANOMALY",
        "criticality": 0.96,
        "country": "Iran / Oman",
        "key_commodities": "Crude Oil (Arab Light/Murban), Qatar LNG, SiC & Polymer Substrates",
        "delay_days": 5.8
    },
    {
        "id": "cp.ukraine_grain",
        "name": "Ukraine Black Sea Grain Corridor",
        "category": "agricultural",
        "latitude": 46.48,
        "longitude": 30.74,
        "stress_level": 0.92,
        "baseline": 0.22,
        "baseline_vessels_day": 65,
        "throughput_pct": 0.46,
        "epistemic_status": "ACTIVE WAR THEATER",
        "criticality": 0.88,
        "country": "Ukraine",
        "key_commodities": "Wheat, Corn, Sunflower Oil, Agricultural Fertilizer, Iron Ore",
        "delay_days": 14.0
    },
    {
        "id": "cp.auto_gulf_of_oman",
        "name": "Gulf of Oman Holding Anchorage",
        "category": "maritime",
        "latitude": 24.0,
        "longitude": 58.0,
        "stress_level": 0.89,
        "baseline": 0.25,
        "baseline_vessels_day": 96,
        "throughput_pct": 0.7,
        "epistemic_status": "CONGESTION & HOLDING PATTERNS",
        "criticality": 0.86,
        "country": "Oman / Iran / UAE",
        "key_commodities": "Crude Oil Tankers, Refined Fuels, Bunkering",
        "delay_days": 5.2
    },
    {
        "id": "cp.suez_canal",
        ...
        "stress_level": 0.89,
        "baseline": 0.18,
        "baseline_vessels_day": 72,
        "throughput_pct": 0.38,
        "epistemic_status": "TRAFFIC SHUTDOWN WATCH",
        "criticality": 0.95,
        "country": "Egypt",
        "key_commodities": "Asia-Europe Containers, Automotive Kits, Refined Chemicals",
        "delay_days": 11.2
    },
    {
        "id": "cp.auto_kerch_strait_approaches",
        "name": "Kerch Strait & Azov Maritime Approaches",
        "category": "maritime",
        "latitude": 45.3,
        "longitude": 36.51,
        "stress_level": 0.88,
        "baseline": 0.2,
        "baseline_vessels_day": 42,
        "throughput_pct": 0.52,
        "epistemic_status": "RESTRICTED NAVAL ZONE",
        "criticality": 0.8,
        "country": "Russia / Ukraine",
        "key_commodities": "Russian Grain, Bulk Ore, Metallurgy, Petrochemicals",
        "delay_days": 8.5
    },
    {
        ...
        "stress_level": 0.86,
        "baseline": 0.1,
        "baseline_vessels_day": 17,
        "throughput_pct": 0.74,
        "epistemic_status": "TELECOM DISRUPTION",
        "criticality": 0.94,
        "country": "Yemen / Saudi Arabia / Egypt",
        "key_commodities": "Asia-Europe Financial EDI, Logistics Booking Networks, Cloud Data",
        "delay_days": 0.0
    },
    {
        "id": "cp.user_fujairah_crude_export_corridor",
        "name": "Fujairah Crude Export Anchorage",
        "category": "energy",
        "latitude": 25.128,
        "longitude": 56.327,
        "stress_level": 0.85,
        "baseline": 0.22,
        "baseline_vessels_day": 85,
        "throughput_pct": 0.73,
        "epistemic_status": "HOLDING ELEVATION",
        "criticality": 0.84,
        "country": "UAE",
        "key_commodities": "Habshan Pipeline Crude Bypass, Marine Fuel Oils",
        "delay_days": 4.6
    },
    {
        "id": "cp.strait_of_malacca",
        "name": "Strait of Malacca & Singapore Anchorage",
        "category": "maritime",
        "latitude": 2.5,
        "longitude": 101.3,
        "stress_level": 0.84,
        "baseline": 0.25,
        "baseline_vessels_day": 285,
        "throughput_pct": 0.72,
        "epistemic_status": "ACUTE CONGESTION ANOMALY",
        "criticality": 0.97,
        "country": "Malaysia / Indonesia / Singapore",
        "key_commodities": "Transshipment Containers, Microcontrollers, Bunkering Fuel",
        "delay_days": 6.4
    },
    {
        ...
        "stress_level": 0.84,
        "baseline": 0.15,
        "baseline_vessels_day": 118,
        "throughput_pct": 0.64,
        "epistemic_status": "CAPACITY OVERLOAD",
        "criticality": 0.86,
        "country": "South Africa",
        "key_commodities": "Diverted Mega-Container Ships (ULCVs), Asian Bulk Exports",
        "delay_days": 12.0
    },
    {
        "id": "cp.port_singapore",
        ...
        "stress_level": 0.84,
        "baseline": 0.22,
        "baseline_vessels_day": 310,
        "throughput_pct": 0.72,
        "epistemic_status": "ACUTE CONGESTION ANOMALY",
        "criticality": 0.98,
        "country": "Singapore",
        "key_commodities": "Container Feeder Cargo, Automotive MCUs (MCU-441), Electronics",
        "delay_days": 6.4
    },
    {
        "id": "cp.taiwan_strait",
        "name": "Taiwan Strait & Formosa Fab Corridor",
        "category": "maritime",
        "latitude": 24.5,
        "longitude": 120.5,
        "stress_level": 0.82,
        "baseline": 0.3,
        "baseline_vessels_day": 240,
        "throughput_pct": 0.81,
        "epistemic_status": "MILITARY SURVEILLANCE",
        "criticality": 0.98,
        "country": "Taiwan / China",
        "key_commodities": "Advanced Logic Wafers (<7nm), Microcontrollers (MCU-441), Display Panels",
        "delay_days": 4.2
    },
    {
        "id": "cp.user_cpc_novorossiysk_export_terminal",
        "name": "CPC Novorossiysk Crude Terminal",
        "category": "energy",
        "latitude": 44.72,
        "longitude": 37.78,
        "stress_level": 0.79,
        "baseline": 0.2,
        "baseline_vessels_day": 18,
        "throughput_pct": 0.72,
        "epistemic_status": "SURFACE DRONE THREAT",
        "criticality": 0.82,
        "country": "Russia / Kazakhstan",
        "key_commodities": "Kazakh CPC Blend Crude, Russian Urals, Fuel Oil",
        "delay_days": 5.0
    },
    {
        "id": "cp.tsmc_hsinchu",
        "name": "TSMC Semiconductor Fabs (Hsinchu / Tainan)",
        "category": "semiconductor",
        "latitude": 24.78,
        "longitude": 120.99,
        "stress_level": 0.76,
        "baseline": 0.2,
        "baseline_vessels_day": 140,
        "throughput_pct": 0.88,
        "epistemic_status": "SINGLE-POINT FAB EXPOSURE",
        "criticality": 0.99,
        "country": "Taiwan",
        "key_commodities": "MCU-441 Microcontrollers, Automotive EV Chips, High-Performance Silicon",
        "delay_days": 3.0
    },
    {
        "id": "cp.panama_canal",
        "name": "Panama Canal Lock System",
        "category": "maritime",
        "latitude": 9.08,
        "longitude": -79.68,
        "stress_level": 0.68,
        "baseline": 0.2,
        "baseline_vessels_day": 38,
        "throughput_pct": 0.76,
        "epistemic_status": "CLIMATIC RESTRICTION",
        "criticality": 0.88,
        "country": "Panama",
        "key_commodities": "US Agricultural Grain to Asia, LPG/LNG, US East Coast Containers",
        "delay_days": 4.8
    },
    {
        "id": "cp.port_jnpt",
        "name": "JNPT Nhava Sheva (Pune Gateway Port)",
        "category": "maritime",
        "latitude": 18.95,
        "longitude": 72.95,
        "stress_level": 0.68,
        "baseline": 0.2,
        "baseline_vessels_day": 52,
        "throughput_pct": 0.8,
        "epistemic_status": "INBOUND CORRIDOR WATCH",
        "criticality": 0.92,
        "country": "India",
        "key_commodities": "Imported Automotive MCUs, SiC MOSFETs, Power Inverters for Pune Cluster",
        "delay_days": 3.1
    },
    {
        ...
        "stress_level": 0.65,
        "baseline": 0.18,
        "baseline_vessels_day": 132,
        "throughput_pct": 0.83,
        "epistemic_status": "REGULATORY INSPECTIONS",
        "criticality": 0.88,
        "country": "Turkey",
        "key_commodities": "Black Sea Agricultural Bulk, Kazakh CPC Crude, Refined Fuel",
        "delay_days": 3.5
    },
    {
        "id": "cp.asml_veldhoven",
        "name": "ASML Veldhoven (EUV Lithography Systems)",
        "category": "semiconductor",
        "latitude": 51.42,
        "longitude": 5.47,
        "stress_level": 0.64,
        "baseline": 0.15,
        "baseline_vessels_day": 12,
        "throughput_pct": 0.85,
        "epistemic_status": "TECH EXPORT CONTROLS",
        "criticality": 0.99,
        "country": "Netherlands",
        "key_commodities": "EUV Lithography Steppers, Precision Optic Assemblies",
        "delay_days": 0.0
    },
    {
        "id": "cp.port_rotterdam",
        ...
        "stress_level": 0.58,
        "baseline": 0.18,
        "baseline_vessels_day": 145,
        "throughput_pct": 0.86,
        "epistemic_status": "FEEDER BUNCHING WATCH",
        "criticality": 0.91,
        "country": "Netherlands",
        "key_commodities": "Petrochemicals, Crude Oil, Automotive Assemblies",
        "delay_days": 2.8
    },
    {
        "id": "cp.gibraltar",
        "name": "Strait of Gibraltar Transit Lane",
        "category": "maritime",
        "latitude": 35.98,
        "longitude": -5.61,
        "stress_level": 0.42,
        "baseline": 0.15,
        "baseline_vessels_day": 210,
        "throughput_pct": 0.92,
        "epistemic_status": "NOMINAL SURVEILLANCE",
        "criticality": 0.85,
        "country": "Spain / Morocco",
        "key_commodities": "Global Transshipment Containers, Atlantic Crude",
        "delay_days": 1.2
    },
    {
        ...
        "stress_level": 0.398,
        "baseline": 0.352,
        "baseline_vessels_day": 117,
        "throughput_pct": 0.77,
        "epistemic_status": "NOMINAL TELEMETRY",
        "criticality": 0.6,
        "country": "Spain/Morocco",
        "key_commodities": "",
        "delay_days": 3.8
    ...
    },
    {
        ...
        "stress_level": 0.38,
        "baseline": 0.15,
        "baseline_vessels_day": 420,
        "throughput_pct": 0.95,
        "epistemic_status": "NOMINAL",
        "criticality": 0.8,
        "country": "UK / France",
        "key_commodities": "Cross-Channel Freight, Automotive Roll-On/Roll-Off",
        "delay_days": 0.8
    },
    {
        "id": "cp.intel_arizona",
...
export const MOCK_SYSTEM_STATUS: SystemStatusResponse = {
  system_live: true,
  ingestion_rate: "48 signals/min",
  model_updated_seconds_ago: 14,
  graph_nodes_count: 136,
  graph_relations_count: 385,
